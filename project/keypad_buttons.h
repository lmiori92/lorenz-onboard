...
typedef enum e_buttons_
{
    ...
    KEYPAD_BTN_WHEEL_DIAL_LEFT_CLICK,
    KEYPAD_BTN_WHEEL_DIAL_RIGHT_UP,
    KEYPAD_BTN_WHEEL_DIAL_RIGHT_DOWN,
    KEYPAD_BTN_WHEEL_BTN_LEFT_UP,
    KEYPAD_BTN_WHEEL_BTN_LEFT_DOWN,
    KEYPAD_BTN_WHEEL_BTN_RIGHT_UP,
    KEYPAD_BTN_WHEEL_BTN_RIGHT_DOWN,
